const _baileysPkg = await import('@whiskeysockets/baileys')
const { generateWAMessageFromContent, proto, prepareWAMessageMedia } = _baileysPkg.proto ? _baileysPkg : (_baileysPkg.default || _baileysPkg)
...
const randomImage = tips[Math.floor(Math.random() * tips.length)];
   var messa = await prepareWAMessageMedia({ image: { url:'https://telegra.ph/file/942364bb842be957c6a02.jpg' } }, { upload: conn.waUploadToServer, logger: console });
